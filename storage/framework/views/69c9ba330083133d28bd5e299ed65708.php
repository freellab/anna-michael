...
<body style="background-color: #F3ECDC; color: black;">
  <nav class="nav">
    <div class="nav-inner">
      <div class="brand">
        <img src="<?php echo e(asset('media/anm-logo-brown.png')); ?>" alt="">
      </div>
      <div class="links">
        <a href="<?php echo e(url('/')); ?>" style="color: #3B1B0E;">Home</a>
        <a href="<?php echo e(url('/details')); ?>" style="color: #3B1B0E;">Details</a>
        <a href="<?php echo e(url('/rsvp')); ?>" style="color: #3B1B0E;">RSVP</a>
      </div>
  ...
  <section class="simple">
    ...
    <form action="https://script.google.com/macros/s/AKfycbzhYDSdUpS68leHueoRKfcoeEB_L1orSkEdtQKrsSjzCjyAWdYGqty0GBKQL5YLf8E/exec" method="POST" id="rsvpForm">
        ...
        <form id="uploadForm" method="POST" action="<?php echo e(route('photos.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH F:\WORK\FREELAB\PROJECT\AMMA N MICHAEL\amma-michael\resources\views/rsvp.blade.php ENDPATH**/ ?>