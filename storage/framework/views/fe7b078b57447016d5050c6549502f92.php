...
<body>
    ...
    <div class="nav-inner">
      ...
      <div class="links">
        ...
        <a href="<?php echo e(url('/details')); ?>">Details</a>
        <a href="<?php echo e(url('/rsvp')); ?>">RSVP</a>
      </div>
  ...
  <header>
    <video autoplay muted loop playsinline preload="auto">
      <source src="<?php echo e(asset('media/dark-wine.mp4')); ?>" type="video/mp4">
  ...
  <section class="simple" style="text-align: center; margin-top: 60px; background-image: url(<?php echo e(asset('media/anm-pattern-bg.png')); ?>); background-size: contain; background-repeat: no-repeat; background-position: center; background-size: 50% auto;">
    ...
    <h4>More love. More Moments. More Everything.</h4>
      ...
      <a class="btn" href="<?php echo e(url('/details')); ?>" style="margin-bottom: 20px;">See Details</a>
      <a class="btn" style="color:#F3ECDC;margin-left:8px" href="<?php echo e(url('/rsvp')); ?>">RSVP</a>
  </section>
  ...
  <div class="our-gallery">
    ...
    <div class="swiper">
        ...
        <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <img src="<?php echo e(asset('storage/' . $photo->filename)); ?>" alt="Gallery Image">
            </div>
  ...
  <footer>All Right Reserved by @Freellab2025</footer>
    ...
    <script src="<?php echo e(asset('js/hum-menu.js')); ?>"></script>
...
<?php /**PATH F:\WORK\FREELAB\PROJECT\AMMA N MICHAEL\amma-michael\resources\views/home.blade.php ENDPATH**/ ?>